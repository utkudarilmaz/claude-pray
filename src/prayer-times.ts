...
function getCacheKey(config: ClaudePrayConfig): string {
...
const MAIN_PRAYERS: (typeof PRAYER_NAMES)[number][] = ['Fajr', 'Dhuhr', 'Asr', 'Maghrib', 'Isha'];

export function calculateNextPrayer(timings: PrayerTimings): NextPrayer | null {
  const now = new Date();
