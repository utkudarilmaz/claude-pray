 ...
 */
export function safeJsonParse(input, validator) {
    try {
...
export function isValidMethod(method) {
    ...
    return (Number.isInteger(method) &&
        method >= 0 &&
        method <= 14 &&
        method !== 6);
}
 ...
 * - Must be a boolean
 */
export function isValidEnabled(enabled) {
...
export function isValidConfig(obj) {
    ...
    const config = obj;
    return (isValidCity(config.city) &&
 ...
 */
export function isValidPrayerTimings(obj) {
    if (typeof obj !== 'object' || obj === null) {
        return false;
    }
    const timings = obj;
    ...
    return requiredPrayers.every(prayer => isValidTimeFormat(timings[prayer]));
}
/**
 ...
 */
export function isValidAladhanResponse(obj) {
    if (typeof obj !== 'object' || obj === null) {
        return false;
    }
    const response = obj;
    ...
    return (typeof data.timings === 'object' &&
        data.timings !== null &&
 ...
 */
export function isValidStdinInput(obj) {
